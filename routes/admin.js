...
router.post(
  ...
  isAuth.isLogedIn,
  adminCon.getEditProfileForm
);
router.post(
  "/editProfileSubmit/:profileId",
  isAuth.isLogedIn,
  body("fname")
    .isAlpha()
  ...
  body("phoneNumber")
    ...
    .withMessage("Please Enter a Valid Phone Number of length 10")
    .trim(),
  adminCon.editProfile
);
...
router.post(
  ...
  body("title")
    .isLength({ min: 3 })
    .withMessage("please enter title more then 2 alphabets"),
  body("category")
    .isLength({ min: 3 })
    .withMessage("Category length Must be greater then 3 alphabets"),
  body("address")
    .isLength({ min: 3 })
    .withMessage("address must contain atleast 3 alphabets"),
  body("entityPhnNum", "Please Enter Correct Phone Number")
    .isMobilePhone()
...
router.get(
  ...
  isAuth.adminIsLogedIn,
  adminCon.viewReportedPost
);
router.post(
  "/deleteReport/:reportId",
  isAuth.adminIsLogedIn,
  adminCon.deleteReport
);
